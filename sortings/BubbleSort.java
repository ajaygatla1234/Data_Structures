...
public class BubbleSort {
	...
	public static void bubbleSort_2(int arr[]) {
		int flag=0;   //flag is used to avoid the useless passes that are not required (if the array got sorted within few passes other passes are useless to perform)
	...
	//Time Complexity
	//worst & Average - O(n^2) 
	//Best-O(n)(if the array is already sorted),O(1)(only if we use flag or check whether it is already sorted or not)
